...
- настройки и параметры ОС (настройка IP стэка, общие каталоги, службы, задания планировщика и т.п.)
...
Командлет позволяет выполнять сбор путем запуска процедуры сбора непосредственно на объекте сбора (**локальный сбор**), так и сбор с нескольких объектов подключенных к локальной сети (**удаленный сбор**), например компьютеров подключенных к сети и включенных в домен Active Directory.
...
Формат имен файлов инвентаризационной информации:
